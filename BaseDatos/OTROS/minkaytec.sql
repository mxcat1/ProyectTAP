...
-- Tiempo de generación: 02-12-2022 a las 15:51:15
...
--
-- Estructura de tabla para la tabla `citas_solicitudes`
--

CREATE TABLE `citas_solicitudes` (
  `idcitas` int(11) NOT NULL,
...
CREATE TABLE `comprobantespagos` (
  ...
  `serie_comprobante` varchar(6) NOT NULL,
...
--
-- Estructura de tabla para la tabla `usuariorol_horarios`
--

CREATE TABLE `usuariorol_horarios` (
...
ALTER TABLE `citas`
  ...
  ADD KEY `fk_Agendas_UsuarioRol1_idx` (`idUsuario`,`idRol`),
  ADD KEY `fk_Agendas_CompendiosActividades1_idx` (`idCompendiosActividades`);

--
-- Indices de la tabla `citas_solicitudes`
--
ALTER TABLE `citas_solicitudes`
  ADD PRIMARY KEY (`idcitas`,`idsolicitudes`),
  ADD KEY `fk_Citas_has_solicitudes_solicitudes1_idx` (`idsolicitudes`),
  ADD KEY `fk_Citas_has_solicitudes_Citas1_idx` (`idcitas`);
...
ALTER TABLE `detalle_solicitud_repuesto`
  ADD PRIMARY KEY (`idRepuestos`,`idsolicitudes`),
...
ALTER TABLE `solicitudes_servicios`
  ADD PRIMARY KEY (`idsolicitudes`,`idservicios`),
...
ALTER TABLE `usuarioespecialidad`
  ADD PRIMARY KEY (`idEspecialidad`,`idUsuario`),
...
--
-- Indices de la tabla `usuariorol_horarios`
--
ALTER TABLE `usuariorol_horarios`
  ADD PRIMARY KEY (`UsuarioRol_idUsuario`,`idRol`,`idhorarios`),
...
--
-- Filtros para la tabla `usuariorol_horarios`
--
ALTER TABLE `usuariorol_horarios`
