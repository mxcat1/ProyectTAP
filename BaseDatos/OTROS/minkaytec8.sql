...
-- Tiempo de generación: 14-12-2022 a las 02:51:38
...
--
-- Estructura de tabla para la tabla `horarios_horastec`
--

CREATE TABLE `horarios_horastec` (
  `idHorarios` int(11) NOT NULL,
  `idHorarioTec` int(11) NOT NULL,
  `estado` bit(1) NOT NULL DEFAULT b'1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `horariotecnico` (
  ...
  `diaSemana` enum('Lunes','Martes','Miercoles','Jueves','Viernes','Sabado') DEFAULT NULL,
...
CREATE TABLE `solicitudes` (
  ...
  `descripcion` varchar(255) NOT NULL,
  `FechaHora_Propuesta` timestamp NOT NULL,
  `FechaHora_Programada` timestamp NOT NULL,
...
ALTER TABLE `compendiosactividades`
  ...
  ADD KEY `fk_idCitas_compendio_idx` (`idCitas`);
...
--
-- Indices de la tabla `horarios_horastec`
--
ALTER TABLE `horarios_horastec`
  ADD KEY `fk_idHorarios_HorasHoraTec_idx` (`idHorarios`),
  ADD KEY `fk_idHorarioTec_idx` (`idHorarioTec`);

--
-- Indices de la tabla `horariotecnico`
--
ALTER TABLE `horariotecnico`
  ADD PRIMARY KEY (`idHorarioTec`),
...
--
-- AUTO_INCREMENT de la tabla `horarios_horastec`
--
ALTER TABLE `horarios_horastec`
  MODIFY `idHorarios` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `horariotecnico`
  MODIFY `idHorarioTec` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `compendiosactividades`
  ...
  ADD CONSTRAINT `fk_idCitas_compendio` FOREIGN KEY (`idCitas`) REFERENCES `citas` (`idCitas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Filtros para la tabla `horarios_horastec`
--
ALTER TABLE `horarios_horastec`
  ADD CONSTRAINT `fk_idHorarioTec` FOREIGN KEY (`idHorarioTec`) REFERENCES `horariotecnico` (`idHorarioTec`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_idHorarios_HorasHoraTec` FOREIGN KEY (`idHorarios`) REFERENCES `horarios` (`idHorarios`) ON DELETE NO ACTION ON UPDATE NO ACTION;
